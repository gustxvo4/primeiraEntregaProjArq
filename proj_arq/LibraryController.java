...
public class LibraryController {
    // comeco Singleton
    private static LibraryController instance; // instanciando o Singleton 
    private Scanner scanner;

    // construtor privado para limitar instanciação
    private LibraryController(Scanner scanner) {
        this.scanner = scanner;
    }

    //metodo para checar se ja tem instancia feita
    public static LibraryController getInstance(Scanner scanner) {
        if (instance == null) {
            instance = new LibraryController(scanner);
        }
        return instance;
    }
    // fim Singleton
